import "../styles/componentStyles/CommentCard.css";
  ...
  return (
    <>
      <div className="comment-card">
        ...
        <div className="commenter-nav">
          <div className="commenter">
            <img className="avatar" src="/images/avatars/image-amyrobson.png" />
            <span className="avatar-name">amyrobson <span className="you">you</span></span>
            <span className="posted-date">1 month ago</span>
          </div>
        ...
        <p className="comment">
          <span className="mention">@maxblagun </span>If you’re still new, I’d recommend focusing on the fundamentals of HTML, CSS, and JS before considering React. It’s very tempting to jump ahead but lay a solid foundation first.
        </p>
      </div>
    </>
  );
